...
- `files/agents/*.md` — owner-specific primary agents, model-backed subagents for delegated passes, and specialized read-only SDLC reviewer subagents (adversarial code review, QA coverage, release readiness, infrastructure security)
